...
export const healthPackages: HealthPackage[] = [
  {
    ...
    description: 'Essential baseline tests for routine health monitoring.',
    price: 999,
    originalPrice: 1899,
    testsIncluded: [
  ...
  },
  {
    ...
    description: 'Full body checkup with critical markers for a complete health assessment.',
    price: 1999,
    originalPrice: 4499,
    testsIncluded: [
  ...
  },
  {
    ...
    description: 'Specialized package for comprehensive heart health and damage monitoring.',
    price: 1599,
    originalPrice: 3299,
    testsIncluded: [
      'Lipid Profile',
  ...
  },
  {
    ...
    description: 'Targeted assessment for male reproductive health and vitality.',
    price: 1899,
    originalPrice: 3899,
    testsIncluded: [
      'Testosterone Total',
