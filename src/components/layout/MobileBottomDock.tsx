    ...
    <div className="sm:hidden fixed bottom-0 left-0 right-0 z-[100] px-2.5 pt-2 pb-[max(0.5rem,calc(env(safe-area-inset-bottom,0px)+4px))] pointer-events-none">
      ...
      <div className="w-full max-w-[420px] mx-auto pointer-events-auto bg-[#102A43]/85 backdrop-blur-[30px] border border-white/20 rounded-[22px] p-1 shadow-[0_16px_40px_rgba(0,0,0,0.35),0_0_0_1px_rgba(255,255,255,0.08)] flex items-center justify-between gap-1 text-white overflow-hidden relative">
        ...
        <PatientReportPortal trigger={
          <button
            className="flex-1 flex items-center justify-center gap-1 min-[360px]:gap-1.5 bg-white/10 hover:bg-white/15 active:bg-white/5 border border-white/10 rounded-[18px] h-11 min-[360px]:h-12 px-1 text-xs font-semibold text-slate-100 transition-all duration-150 active:scale-[0.95] select-none cursor-pointer min-w-0 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-[#102A43]"
        ...
        <button
          ...
          className="flex-[1.2] flex items-center justify-center gap-1 min-[360px]:gap-1.5 bg-white text-[#102A43] rounded-[18px] h-11 min-[360px]:h-12 px-1.5 min-[360px]:px-2.5 text-xs font-bold shadow-[0_4px_12px_rgba(255,255,255,0.2)] transition-all duration-150 hover:bg-white/90 active:scale-[0.95] select-none border border-white cursor-pointer min-w-0 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-[#102A43]"
        ...
        <a
          ...
          className="w-11 h-11 min-[360px]:w-12 min-[360px]:h-12 shrink-0 flex items-center justify-center bg-white/10 hover:bg-white/15 active:bg-white/5 border border-white/10 rounded-[18px] transition-all duration-150 active:scale-[0.95] select-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-[#102A43]"
        ...
        <button
          ...
          className="w-11 h-11 min-[360px]:w-12 min-[360px]:h-12 shrink-0 flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] rounded-[18px] transition-all duration-150 active:scale-[0.95] shadow-xs select-none border border-[#25D366] cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-[#102A43]"
